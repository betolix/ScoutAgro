...
function subirPorTipo( tipo, id, nombreArchivo, res) {
    ...
    if ( tipo === 'usuarios') {
        ...
        pool.query('select _id, primer_nombre, email_1, password, img, role_id, google  from t_usuario WHERE _id= $1 ', [id], (err, usuario) => {
            console.log('err', err);
            ...
            pool.query('UPDATE t_usuario SET img=$1 WHERE _id=($2) RETURNING *', [nombreArchivo, id], (error, usuarioActualizado) => {
